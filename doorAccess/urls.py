...
router.register('DoorAcContPhase1', doorAccews_views.NfcDooorAcContPhase1ViewSet, base_name='NfcDACP1')
router.register('DoorAcContPhase2', doorAccews_views.NfcDooorAcContPhase2ViewSet, base_name='NfcDACP2')
router.register('DoorAcContPhase3', doorAccews_views.NfcDooorAcContPhase3ViewSet, base_name='NfcDACP3')
urlpatterns = [
